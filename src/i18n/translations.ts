...
export const translations = {
  es: {
    ...
    quotePay: "Pagar",
    quotePaySoon: "Pago online en preparación. Mientras, usa presupuesto especial si lo necesitas.",
  ...
  en: {
    ...
    quotePay: "Pay",
    quotePaySoon: "Online payment coming soon. Use special quote if you need a custom deal.",
  ...
  fr: {
    ...
    quotePay: "Payer",
    quotePaySoon: "Paiement en ligne en préparation. Utilisez le devis spécial si besoin.",
