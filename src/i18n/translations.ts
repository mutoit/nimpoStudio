...
export const translations = {
  es: {
    ...
    quoteLiveLabel: "Total",
    quoteSubmit: "Obtener presupuesto",
    quotePay: "Pagar",
    quotePaySoon: "Esta obra aún no tiene master HQ para descarga. Puedes pedir presupuesto especial.",
    ...
    usagePersonalPrivate: "Personal / privado (sin negocio) — 49 €",
    usageFilmShort: "Cine: corto / festival / student film — 79–169 €",
    usageFilmFeature: "Cine: largometraje / productora — 590 €",
    usageSeriesOne: "Serie / webserie: 1 episodio — 79–169 €",
    usageSeriesMulti: "Serie: varios episodios — 590 €",
    usageBrandVideo: "Vídeo de marca / corporativo (1 pieza) — 79–169 €",
    usageSocialBrand: "Redes de marca (1 campaña orgánica) — 79–169 €",
    usagePodcastOne: "Podcast: 1 episodio — 79–169 €",
    usageAdsPaid: "Publicidad / ads de pago — 209–299 €",
    usageAdsPaidHint:
      "Base del plazo + 130 € ads: micro 79+130=209 € · 1 año 129+130=259 € · proyecto 159+130=289 € · 2 años 169+130=299 €.",
    usageGameIndie: "Juego indie (1 título / uso declarado) — 79–169 €",
    usageGameLiveops: "Juego live-ops / marketing continuo — 790 €/año",
    usageAppOne: "App móvil / software (1 app, uso fijo) — 79–169 €",
    usageAppSaas: "SaaS / app con suscripción o uso ilimitado — 790 €/año",
    usageInstallOne: "Instalación / museo / evento puntual — 79–169 €",
    usageTourEvent: "Tour / multi-ciudad / multi-fecha — 590 €",
    usageExclusive: "Exclusiva por alcance — desde 890 €",
    usageBuyout: "Buyout total / fuera de catálogo — 2.990 €",
    usageOther: "Broadcast / TV / SVOD (no exclusiva) — 1.200 €",
    ...
    productFeedEyebrow: "Productos",
    productFeedTitle: "Novedades de productos",
    productFeedDesc: "Updates de software y tools del estudio.",
    productFeedEmpty: "Sin posts de productos aún.",
    productFeedEmptyForProduct: "Sin updates de este producto.",
    newsletterTitle: "Avisos por email",
    newsletterLead: "Producto o música nueva. Confirmas el email y puedes darte de baja cuando quieras.",
    newsletterEmail: "Tu email",
    newsletterSubmit: "Abonarme",
    newsletterOk: "Revisa tu email y confirma el abono.",
    newsletterAlready: "Este email ya está abonado.",
    newsletterErr: "No se pudo completar. Inténtalo de nuevo.",
    newsletterPrivacy: "Solo novedades del estudio. Sin spam.",
    tagNew: "Nuevo",
  ...
  en: {
    ...
    quotePay: "Pay",
    quotePaySoon: "This work has no HQ master yet. You can request a special quote.",
    ...
    usagePersonalPrivate: "Personal / private (no business) — €49",
    usageFilmShort: "Film: short / festival / student — €79–169",
    usageFilmFeature: "Film: feature / major production — €590",
    usageSeriesOne: "Series / web series: 1 episode — €79–169",
    usageSeriesMulti: "Series: multiple episodes — €590",
    usageBrandVideo: "Brand / corporate video (1 piece) — €79–169",
    usageSocialBrand: "Brand social (1 organic campaign) — €79–169",
    usagePodcastOne: "Podcast: 1 episode — €79–169",
    usageAdsPaid: "Advertising / paid ads — €209–299",
    usageAdsPaidHint:
      "Term base + €130 ads: micro €79+€130=€209 · 1y €129+€130=€259 · project €159+€130=€289 · 2y €169+€130=€299.",
    usageGameIndie: "Indie game (1 title / declared use) — €79–169",
    usageGameLiveops: "Live-ops game / ongoing marketing — €790/yr",
    usageAppOne: "Mobile app / software (1 app, fixed use) — €79–169",
    usageAppSaas: "SaaS / unlimited-use app — €790/yr",
    usageInstallOne: "Installation / museum / one-off event — €79–169",
    usageTourEvent: "Tour / multi-city / multi-date — €590",
    usageExclusive: "Scoped exclusivity — from €890",
    usageBuyout: "Full buyout / leave catalog — €2,990",
    usageOther: "Broadcast / TV / SVOD (non-exclusive) — €1,200",
    ...
    productFeedEyebrow: "Products",
    productFeedTitle: "Product updates",
    productFeedDesc: "News about studio software and tools.",
    productFeedEmpty: "No product posts yet.",
    productFeedEmptyForProduct: "No updates for this product.",
    newsletterTitle: "Email updates",
    newsletterLead: "New product or music. Confirm your email; unsubscribe anytime.",
    newsletterEmail: "Your email",
    newsletterSubmit: "Subscribe",
    newsletterOk: "Check your email and confirm the subscription.",
    newsletterAlready: "This email is already subscribed.",
    newsletterErr: "Could not complete. Try again.",
    newsletterPrivacy: "Studio news only. No spam.",
    tagNew: "New",
  ...
  fr: {
    ...
    productDemoBeta: "Essayer la bêta",
    ...
    quotePay: "Payer",
    quotePaySoon: "Cette œuvre n’a pas encore de master HQ. Demandez un devis spécial.",
    ...
    usagePersonalPrivate: "Personnel / privé (sans business) — 49 €",
    usageFilmShort: "Cinéma : court / festival / étudiant — 79–169 €",
    usageFilmFeature: "Cinéma : long métrage / grosse prod — 590 €",
    usageSeriesOne: "Série / websérie : 1 épisode — 79–169 €",
    usageSeriesMulti: "Série : plusieurs épisodes — 590 €",
    usageBrandVideo: "Vidéo de marque / corporate (1 pièce) — 79–169 €",
    usageSocialBrand: "Réseaux de marque (1 campagne organique) — 79–169 €",
    usagePodcastOne: "Podcast : 1 épisode — 79–169 €",
    usageAdsPaid: "Publicité / pubs payantes — 209–299 €",
    usageAdsPaidHint:
      "Base durée + 130 € ads : micro 79+130=209 € · 1 an 129+130=259 € · projet 159+130=289 € · 2 ans 169+130=299 €.",
    usageGameIndie: "Jeu indé (1 titre / usage déclaré) — 79–169 €",
    usageGameLiveops: "Jeu live-ops / marketing continu — 790 €/an",
    usageAppOne: "App mobile / logiciel (1 app, usage fixe) — 79–169 €",
    usageAppSaas: "SaaS / app usage illimité — 790 €/an",
    usageInstallOne: "Installation / musée / événement ponctuel — 79–169 €",
    usageTourEvent: "Tournée / multi-villes — 590 €",
    usageExclusive: "Exclusivité par périmètre — dès 890 €",
    usageBuyout: "Buyout total / hors catalogue — 2 990 €",
    usageOther: "Broadcast / TV / SVOD (non exclusif) — 1 200 €",
    ...
    productFeedEyebrow: "Produits",
    productFeedTitle: "Nouveautés produits",
    productFeedDesc: "Mises à jour des logiciels et outils du studio.",
    productFeedEmpty: "Aucun post produit pour l'instant.",
    productFeedEmptyForProduct: "Aucune mise à jour pour ce produit.",
    newsletterTitle: "Alertes e-mail",
    newsletterLead: "Nouveau produit ou musique. Confirmez l'e-mail ; désinscription libre.",
    newsletterEmail: "Votre e-mail",
    newsletterSubmit: "M'abonner",
    newsletterOk: "Vérifiez votre e-mail et confirmez l'abonnement.",
    newsletterAlready: "Cet e-mail est déjà abonné.",
    newsletterErr: "Échec. Réessayez.",
    newsletterPrivacy: "Uniquement les actus du studio. Pas de spam.",
    tagNew: "Nouveau",
