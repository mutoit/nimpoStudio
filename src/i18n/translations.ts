...
export const translations = {
  es: {
    ...
    quoteTerm2y: "2 años (estándar catálogo)",
    quoteTerm1y: "1 año",
    quoteTermProject: "Vida del proyecto",
  ...
  en: {
    ...
    quoteTerm2y: "2 years (catalog standard)",
    quoteTerm1y: "1 year",
    quoteTermProject: "Project lifetime",
  ...
  fr: {
    ...
    quoteTerm2y: "2 ans (standard catalogue)",
    quoteTerm1y: "1 an",
    quoteTermProject: "Durée du projet",
